...
describe('Testing interactions on MoviesList', () => {
  ...
  const wrapper = mount(<MockTheme><MoviesList searchResult={searchResult} nominationList={""} addMovieToNominationList={addMovieToNominationList}></MoviesList></MockTheme>)

  test('Test if Movieslist renders without crash', () => {
      const div = document.createElement("div")
      let searchMoviesByName = jest.fn()
      ReactDOM.render(<MockTheme><MoviesList searchResult={searchResult} nominationList={""} addMovieToNominationList={addMovieToNominationList}></MoviesList></MockTheme>, div)
