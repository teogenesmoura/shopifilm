...
test('clicking "search movie" submits request to external API', async () => {
  const wrapper = render(<MockTheme><DashboardContainer></DashboardContainer></MockTheme>)
...
describe('Testing interactions on DashboardContainer', () => {
  ...
  test('sets state from local storage', () => {
    ...
    const dashboard = mount(<MockTheme><DashboardContainer></DashboardContainer></MockTheme>)
  })
